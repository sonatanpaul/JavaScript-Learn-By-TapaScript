...
// findIndex ()  Method :
{
  ...
  const foundYoungIndex = customers.findIndex((customer) => {
    return customer.age < 10;
  });

  console.log(foundYoungIndex); // 4
}
...
// findLastIndex ()  Method :
{
  ...
  const foundYoungLastIndex = customers.findLastIndex((customer) => {
    return customer.age < 10;
  });

  console.log(foundYoungLastIndex); // 4
}
...
// findLast ()  Method :
{
  ...
  const foundYoungLastIndex = customers.findLast((customer) => {
    return customer.age < 10;
  });
...
// Chaining Array Method :
{
  ...
  const mariedCustomer = customers.filter((customer) => {
    return customer.married;
  });
  console.log(mariedCustomer);
  const mariedCustomerExpense = mariedCustomer.map((customer) => {
    return customer.expense;
  });
  console.log(mariedCustomerExpense);
  const mariedCustomerTotalExpense = mariedCustomerExpense.reduce(
    (acc, expence) => {
      return acc + expence;
    }
  );
  console.log(mariedCustomerTotalExpense);

  // Array method Chaining
  const totalMaridCustomerExpense = customers
    .filter((customer) => {
      return customer.married;
    })
    .map((cusomer) => {
      return cusomer.expense;
    })
